...
//    private Drawable mClearDrawable;
    ...
    private OnTextCompleteListener onTextComplete;
...
//                getCompoundDrawables()[1], right, getCompoundDrawables()[3]);
    ...
    public void afterTextChanged(Editable s) {
        ...
        Log.v(GlobalConstants.LOG_TAG, "content==" + content);
        if (onTextComplete != null)
            onTextComplete.onText(content);
    }
    ...
    public void setClearListenerListener(OnClearListener onClearListener) {
        this.onClearListener = onClearListener;
    }

    public void setOnTextCompleteListener(OnTextCompleteListener onTextComplete) {
